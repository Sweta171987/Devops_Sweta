...
Function Main
	...
	' referencing a non existant jar has no effect on the application
	'
	LOCALCLASSPATH = Chr(34) & OMNIHOME & "\java\jars\oem_administrator.jar" & Chr(34) & ";" & _
	...
	COMMANDLINE = Chr(34) & _
		      ...
		      " " & P_ARCHDIR & _
		      " " & P_MEMORY & _
		      " com.micromuse.centralconfig.LaunchApplication" & _
		      ArgList & _
		      Chr(34)
