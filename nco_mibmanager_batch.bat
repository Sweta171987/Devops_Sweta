...
REM with IBM Corp.
REM
REM nco_mibmanager script - Starts the MibManager program in batch mode
REM
...
set LAUNCHER_JAR=%MMPATH%\plugins\org.eclipse.equinox.launcher_1.2.0.v20110502.jar

REM Run MibManager
"%NCO_JRE%\bin\java" -jar "%LAUNCHER_JAR%" -application MIB_Manager.headless %*
